        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mb-6 bg-blue-50 p-4 rounded border border-blue-200">
                    <p class="text-sm text-blue-800">Current Stock: <span class="font-bold text-lg">{{ $fabric->stock_meter }} Meters</span></p>
                </div>
                ...
                <form method="POST" action="{{ route('fabrics.updateStock', $fabric->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="change_amount" class="w-full border rounded px-3 py-2" placeholder="Example: 50" required min="1">
                        <p class="text-xs text-gray-500 mt-1">Masukkan angka positif saja. Sistem akan otomatis mengurangi jika tipe Sold/Damage.</p>
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Note (Optional)</label>
                        <textarea name="note" class="w-full border rounded px-3 py-2" rows="2" placeholder="Ex: Pembelian dari Supplier A"></textarea>
                    </div>
