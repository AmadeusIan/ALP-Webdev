        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="w-full md:w-1/3 bg-gray-200 h-64 rounded-lg flex items-center justify-center text-gray-500">
                        No Image
                    </div>
                    ...
                    <div class="w-full md:w-2/3">
                        ...
                        <div class="mb-6">
                            ...
                            <span class="text-2xl font-bold text-blue-700">Rp {{ number_format($fabric->price_per_meter, 0, ',', '.') }} / meter</span>
                        </div>
                        ...
                        <div class="flex gap-3 border-t pt-4">
                            <a href="{{ route('fabrics.edit', $fabric) }}" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Edit Info</a>
                            <a href="{{ route('fabrics.restock', $fabric) }}" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">Manage Stock</a>
                            
                            <form action="{{ route('fabrics.destroy', $fabric) }}" method="POST" onsubmit="return confirm('Delete this fabric?')">
                                @csrf @method('DELETE')
