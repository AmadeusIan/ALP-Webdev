...
<body class="antialiased font-sans text-gray-800 bg-white selection:bg-black selection:text-white">
    ...
    <section class="py-32 bg-white" id="team">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-20">
                <h2 class="text-4xl font-serif font-bold text-gray-900 mb-4 uppercase tracking-wide">Client Stories
                </h2>
                <div class="w-12 h-0.5 bg-black mx-auto mt-6"></div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div style="width: 100%; position: relative;">
                <iframe width="100%" height="450" frameborder="0" scrolling="no" marginheight="0"
                    marginwidth="0"
                    src="https://maps.google.com/maps?q=Jl.+Griya+Babatan+Mukti+Blok+P+No.20,+Babatan,+Kec.+Wiyung,+Surabaya&t=&z=17&ie=UTF8&iwloc=&output=embed">
                </iframe>

            <div
                class="absolute bottom-0 left-0 bg-white/95 backdrop-blur-sm p-8 max-w-sm m-6 shadow-lg border-l-4 border-black pointer-events-none md:block hidden">
